...
let playerItems: string = "Lange Lanze";
...
let Items: string[] = ["Mayonnaise, Radiesschen, Bagger mit zwei Schaufeln, Teleskop mit Rheuma"]

let Bildquellen: string [] = ["Monster1.png", "monster2.jpg"]
...
function generateMonster()
{
    ...
    console.log(monsterArray.length -1].monsterExperience);                    // Man kann nur auf Array-Teile zugreifen, welche definiert sind. -1 ist nicht definitiert (und wird es auch nie sein).
...
function generateMonsterName() : string
{
    ...
    generateNewImageSource(rngNumber);                           // Füge den Monsternamen zusammen: nimm aus dem entsprechenden Array mit der zufallsgenerierten Zahl den entsprechenden Eintrag.
...
let list: string[] = [https://www.google.com/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&ved=2ahUKEwjov7Glu8jiAhURPFAKHXQ6C5IQjRx6BAgBEAU&url=https%3A%2F%2Fde.kisspng.com%2Fpng-jt2huq%2F&psig=AOvVaw0rR93NCjKXMbRemchwa3-E&ust=1559484203634652];
