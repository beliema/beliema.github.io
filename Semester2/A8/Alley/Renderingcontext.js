...
(function (L08_Canvas_Alley) {
    ...
    function drawTrees(_nTrees, //Anzahl von Bäumen 
    _posStart, //Startsposition hinten
    _posEnd, //Endposition vorne
    _minScale, // 
    _stepPos, // jetzige Position des Baumes
    _stepScale) {
    ...
    function drawBackground() {
        ...
        let gradient = crc2.createLinearGradient(0, 0, 0, crc2.canvas.height); //Farbverlauf im Hintergrund
    ...
    function drawSun(_position) {
        ...
        let r1 = 30; //innerer Kreis
        let r2 = 150; //äußerer Kreis
